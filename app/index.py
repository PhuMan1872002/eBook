...
app.add_url_rule('/', view_func=controllers.index,  methods=['GET'])
...
def common_responses():
    return {
        ...
        'cashier_stats':utils.cart_stats(session.get('cartCashier')),
        'print_cart_stats':utils.cart_stats(session.get('print_cart'))
    }
