...
from app.models import Category, Book, UserRoleEnum, Author, book_author, Receipt, ReceiptDetails,User
...
admin.add_view(MyProductView(Book, db.session, name='Book'))
admin.add_view(MyAuthorView(Author, db.session, name='Author'))
# admin.add_view(MyBookAuthorView(book_author, db.session, name='Author and Book'))
